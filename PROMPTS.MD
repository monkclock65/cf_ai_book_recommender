...
Agent used: GPT-5 via Github Copilot

this document shows the iterative development process, as well as debugging and architecture decisions made during development. all code was checked and manually edited to make sure it was correct and ai was only used as an assistant to improve upon my design. 
...
fix the valid ai parsing and remove the json ''' from the response